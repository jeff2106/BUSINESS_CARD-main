...
export default function EditProfile({ route, navigation }) {
  ...
  function sendData() {
    ...
    formdata.append('entreprise_description', '');
    ...
    fetch(
      ...
      console.log(UserDetail);
        ...
        navigation.navigate('SuccesUpdate', {
          id: id,
          Token: Token,
          Data: UserDetail
        })
